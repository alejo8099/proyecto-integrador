...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="form-group">
            ...
            <select name="tipo_habitante" id="habitante_id" class="form-control selectpicker" data-livesearch="true">

                @foreach($detalle_habitantes as $hd)
                <option value="{{$hd->tipo_habitante}}" selected>{{$hd->tipo_habitante}}</option>
                @endforeach
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="form-group">
            ...
            <select name="apartamento_id" id="apartamento_id" class="form-control selectpicker" data-livesearch="true">
                ...
                <option value="{{$ap->id}}" diseable selected>{{$ap->numero_apartamento}} - {{$ap->bloque}}</option>
